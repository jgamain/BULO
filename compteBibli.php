		...
		<div class="container">
			...
			<form class="form-horizontal hidden" method="post" action="ajoutLivre.php">
				...
				<div class="form-group">
					...
					<div class="col-sm-3"><input type="text" class="form-control" name="nomAuteur1" placeholder="Nom de l'auteur"></div>
					<div class="col-sm-3"><input type="text" class="form-control" name="prenomAuteur1" placeholder="Prénom de l'auteur"></div>
				</div>
				<div class="form-group">
					<label for="auteur2" class="col-sm-2 control-label">Auteur 2</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="nomAuteur2" placeholder="Nom de l'auteur"></div>
					<div class="col-sm-3"><input type="text" class="form-control" name="prenomAuteur2" placeholder="Prénom de l'auteur"></div>
				</div>
				<div class="form-group">
					<label for="auteur3" class="col-sm-2 control-label">Auteur 3</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="nomAuteur3" placeholder="Nom de l'auteur"></div>
					<div class="col-sm-3"><input type="text" class="form-control" name="prenomAuteur3" placeholder="Prénom de l'auteur"></div>
				</div>
				...
				<div class="form-group">
					<label for="newCollection" class="col-sm-2 control-label">Autre collection</label>
					<div class="col-sm-6"><input type="text" class="form-control" name="newCollection" placeholder="Nom de la collection"></div>
				</div>
				
				
				<div class="form-group">
					<label for="editeur1" class="col-sm-2 control-label">Editeur 1</label>
					<div class="col-sm-6"><input type="text" class="form-control" name="editeur1" placeholder="Nom de l'éditeur"></div>
				</div>
				<div class="form-group">
					<label for="editeur2" class="col-sm-2 control-label">Editeur 2</label>
					<div class="col-sm-6"><input type="text" class="form-control" name="editeur2" placeholder="Nom de l'éditeur"></div>
				</div>
				<div class="form-group">
